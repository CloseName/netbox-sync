...
class ErrorCode(str, Enum):
    ...
    HOST_IDENTITY_INVALID = 'HOST_IDENTITY_INVALID'
    HOST_IDENTITY_INCONSISTENT = 'HOST_IDENTITY_INCONSISTENT'
    HOST_INVENTORY_EMPTY = 'HOST_INVENTORY_EMPTY'
    ...
    REGISTRATION_CLUSTER_RETAINED = 'REGISTRATION_CLUSTER_RETAINED'
